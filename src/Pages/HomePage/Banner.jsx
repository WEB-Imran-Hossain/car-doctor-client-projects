...
const Banner = () => {
    return (
        <div className="carousel w-full h-[520px]  lg:h-[680px]">
            {/* slider one */}
            <div id="slide1" className="carousel-item relative w-full">
                <img src="https://i.ibb.co/cbMT6qt/5.jpg" className="w-full lg:rounded-lg" />
                <div className="absolute h-full left-0 flex items-center top-0 text-white bg-gradient-to-r from-[#151515] to-[rgba(21, 21, 21, 0.00)] lg:rounded-lg">
                ...
                <div className="absolute flex justify-center md:justify-end transform -translate-y-1/2 md:left-5 md:right-5 left-40 bottom-0">
            ...
            <div id="slide2" className="carousel-item relative w-full">
                <img src="https://i.ibb.co/sQLvD4j/6.jpg" className="w-full lg:rounded-lg" />
                <div className="absolute h-full left-0 flex items-center top-0 text-white bg-gradient-to-r from-[#151515] to-[rgba(21, 21, 21, 0.00)] lg:rounded-lg">
                    <div className='w-96 lg:w-1/2 space-y-7 pl-12 text-center md:text-left'>
                        <h2 className='text-5xl lg:text-6xl font-bold'>Affordable Price For Car Servicing</h2>
                        <p className='text-lg font-normal'>There are many variations of passages of  available, but the majority have suffered alteration in some form</p>
            ...
            <div id="slide3" className="carousel-item relative w-full">
                <img src="https://i.ibb.co/55LWP2R/2.jpg" className="w-full lg:rounded-lg" />
                <div className="absolute h-full left-0 flex items-center top-0 text-white bg-gradient-to-r from-[#151515] to-[rgba(21, 21, 21, 0.00)] lg:rounded-lg">
                    <div className='w-96 lg:w-1/2 space-y-7 pl-12 text-center md:text-left'>
                        <h2 className='text-5xl lg:text-6xl font-bold'>Affordable Price For Car Servicing</h2>
                        <p className='text-lg font-normal'>There are many variations of passages of  available, but the majority have suffered alteration in some form</p>
            ...
            <div id="slide4" className="carousel-item relative w-full">
                <img src="https://i.ibb.co/QPCnPS3/1.jpg" className="w-full lg:rounded-lg" />
                <div className="absolute h-full left-0 flex items-center top-0 text-white bg-gradient-to-r from-[#151515] to-[rgba(21, 21, 21, 0.00)] lg:rounded-lg">
                    <div className='w-96 lg:w-1/2 space-y-7 pl-12 text-center md:text-left'>
                        <h2 className='text-5xl lg:text-6xl font-bold'>Affordable Price For Car Servicing</h2>
                        <p className='text-lg font-normal'>There are many variations of passages of  available, but the majority have suffered alteration in some form</p>
